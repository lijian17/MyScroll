...
public class MainActivity extends Activity implements ScrollViewListener, OnCheckedChangeListener {
	...
	private void initUI() {
		...
		mFl_1 = (FrameLayout) findViewById(R.id.fl_1);
		mFl_2 = (FrameLayout) findViewById(R.id.fl_2);
	...
	private void initUI1() {
		mTxt_main_1 = (TextView) findViewById(R.id.scroll_main_txt_1);

		scroll_left_1 = (SyncScrollView) findViewById(R.id.scroll_left_1);
		scroll_left_1.ableScroll(false);

		scroll_top_1 = (SyncHorizontalScrollView) findViewById(R.id.scroll_top_1);
		scroll_top_1.ableScroll(false);

		scroll_center_1 = (HVScrollView) findViewById(R.id.scroll_center_1);
		scroll_center_1.ableScroll(false);

		scroll_main_1 = (HVScrollView) findViewById(R.id.scroll_main_1);
		...
		mLl_ChartName_1 = (LinearLayout) findViewById(R.id.ll_ChartName_1);
		mLl_ChartTitle_1 = (LinearLayout) findViewById(R.id.ll_ChartTitle_1);
		mLl_ChartPeriod_1 = (LinearLayout) findViewById(R.id.ll_ChartPeriod_1);
		mLl_ChartNumber_1 = (LinearLayout) findViewById(R.id.ll_ChartNumber_1);
	}

	private void initUI2() {
		mTxt_main_2 = (TextView) findViewById(R.id.scroll_main_txt_2);

		scroll_left_2 = (SyncScrollView) findViewById(R.id.scroll_left_2);
		scroll_left_2.ableScroll(false);

		scroll_top_2 = (SyncHorizontalScrollView) findViewById(R.id.scroll_top_2);
		scroll_top_2.ableScroll(false);

		scroll_center_2 = (HVScrollView) findViewById(R.id.scroll_center_2);
		scroll_center_2.ableScroll(false);

		scroll_main_2 = (HVScrollView) findViewById(R.id.scroll_main_2);
		...
		mLl_ChartName_2 = (LinearLayout) findViewById(R.id.ll_ChartName_2);
		mLl_ChartTitle_2 = (LinearLayout) findViewById(R.id.ll_ChartTitle_2);
		mLl_ChartPeriod_2 = (LinearLayout) findViewById(R.id.ll_ChartPeriod_2);
		mLl_ChartNumber_2 = (LinearLayout) findViewById(R.id.ll_ChartNumber_2);
	}
	...
	private void initData2() {
		for (int i = mArr_Num_2.length; i < 0; i--) {
