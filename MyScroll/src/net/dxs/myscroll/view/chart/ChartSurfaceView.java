package net.dxs.myscroll.view.chart;
...
public class ChartSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
	...
	public ChartSurfaceView(Context context, float width, float height, int rowNum, String[] strs) {
		super(context);
		...
		holder.addCallback(this);//保证下面三个方法有效
		init();
	}
